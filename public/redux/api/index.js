...
export const getNotice = (notice) => 
  API.post("/api/admin/getnotice", notice);


export const uploadAttendance = (attendanceData) =>
  API.post("/api/admin/uploadattendance", attendanceData);
export const uploadMarks = (getMarksStudent) =>
  API.post("/api/admin/uploadMarks", getMarksStudent);

export const projectMarks = (getprojectMarks) =>
  API.post("/api/admin/projectMarks", getprojectMarks);
