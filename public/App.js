...
import UploadAttendance from "./components/admin/uploadAttendance/UploadAttendance";
import UploadMarks from "./components/admin/uploadMarks/UploadMarks";
...
const App = () => {
  return (
    <Routes>
      ...
      <Route path="/admin/uploadattendance"element={<UploadAttendance/>}/>
      <Route path="/admin/uploadMarks"element={<uploadMarks/>}/>
