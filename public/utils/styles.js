export const adminData =
  "flex flex-col overflow-y-auto scrollbar-thin scrollbar-track-white scrollbar-thumb-black h-[35rem]  shadow-lg pl-5 rounded-md overflow-x-hidden";

export const adminDataBody =
  "grid grid-cols-24 hover:scale-105 transition-all duration-150";
